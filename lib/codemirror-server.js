...
function CodeMirrorServer (document, operations, docId, mayWrite) {
...
util.inherits(CodeMirrorServer, Server);
extend(CodeMirrorServer.prototype, EventEmitter.prototype);
...
CodeMirrorServer.prototype.addClient = function (socket) {
  var self = this;
  socket
    .join(this.docId)
    .emit('doc', {
...
CodeMirrorServer.prototype.onOperation = function (socket, revision, operation, cursor) {
  var wrapped;
  try {
...
module.exports = CodeMirrorServer;