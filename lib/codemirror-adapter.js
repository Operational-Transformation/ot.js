...
ot.CodeMirrorAdapter = (function () {
  ...
  function CodeMirrorAdapter (cm) {
    ...
    var self = this;
    this.cmChangeListener = function (_, change) { self.onChange(change); };
    this.cmCursorActivityListener = function () { self.trigger('cursorActivity'); };
    this.cmBlurListener = function () { self.onBlur(); };
    this.cmFocusListener = function () { self.trigger('cursorActivity'); };
    cm.on('change', this.cmChangeListener);
    cm.on('cursorActivity', this.cmCursorActivityListener);
    cm.on('blur', this.cmBlurListener);
    cm.on('focus', this.cmFocusListener);
  }
  ...
  CodeMirrorAdapter.prototype.removeCodeMirrorListeners = function () {
    cm.off('change', this.cmChangeListener);
    cm.off('cursorActivity', this.cmCursorActivityListener);
    cm.off('blur', this.cmBlurListener);
    cm.off('focus', this.cmFocusListener);
  };
